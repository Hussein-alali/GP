...
//           <span className="nav-text-label">القائمة</span>
...
//       <div className="nav-section">
//         <div className="nav-item">
//           <span className="nav-text-label">English</span>
//           <div className="nav-icon-circle">
...
//             <span className="nav-text-label">تسجيل الدخول</span>
//             <div className="nav-icon-circle">
//                {/* User Icon */}
...
//             <span className="nav-text-label">تسجيل الاهتمام</span>
    ...
    <nav className="transparent-nav">
      ...
      <Link href="/" className="logo-container" style={{ textDecoration: 'none', cursor: 'pointer' }}>
        <div className="logo-wrapper">
            <img src="/RealStateLogo.jpg" alt="Logo" className="logo-img-cropped" />
        </div>
        <span className="logo-text-new">SMART ESTATE</span>
      </Link>
